      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
          ...
          <div className="relative order-2 md:order-1">
            ...
            <div className="hidden md:block absolute -right-8 top-1/4 w-32 h-48 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-2xl shadow-xl transform rotate-12"></div>
            <div className="hidden md:block absolute -right-4 bottom-1/4 w-24 h-40 bg-gradient-to-br from-amber-100 to-amber-200 rounded-2xl shadow-xl transform -rotate-6"></div>
          </div>

          {/* Content Side */}
          <div className="order-1 md:order-2">
            <div className="mb-6 sm:mb-8">
              <p className="text-primary font-semibold text-base sm:text-lg mb-2">About Us</p>
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-gray-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center">
                <Users className="w-6 h-6 sm:w-8 sm:h-8 text-gray-700 mx-auto mb-1 sm:mb-2" />
              ...
              <div className="bg-lime-400 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center shadow-lg">
                <ThumbsUp className="w-6 h-6 sm:w-8 sm:h-8 text-gray-900 mx-auto mb-1 sm:mb-2" />
                <div className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">1</div>
                <div className="text-xs sm:text-sm text-gray-900 font-medium">Top Brand</div>
              </div>
              <div className="bg-gray-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center">
                <Award className="w-6 h-6 sm:w-8 sm:h-8 text-gray-700 mx-auto mb-1 sm:mb-2" />
