          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-base font-bold text-white uppercase tracking-tight">Creative</span>
                <span className="text-base font-bold text-white uppercase tracking-tight">Valley</span>
              </div>
            </div>
